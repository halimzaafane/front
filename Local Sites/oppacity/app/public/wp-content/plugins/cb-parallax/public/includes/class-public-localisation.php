...
class cb_parallax_public_localisation {
	...
	public function add_hooks() {
		...
		add_action( 'wp_enqueue_scripts', [$this, 'localize_frontend'], 40 );
	}
	...
	private function getPrepareData() {
        /**
         * @var \WP_Post $post
         */
        global $post;
	...
	public function localize_frontend() {
		...
		if (false !== $data){
            wp_localize_script('cb-parallax-public-js', 'Cb_Parallax_Public', $data);
